...
class PharmacyMedicinesView extends GetView<MedicinesController> {
  @override
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          if (!Get.find<PharmaciesLaravelApiClient>()
              .isLoading(tasks: ['getPharmacyMedicines', 'getPharmacyPopularMedicines', 'getPharmacyMostRatedMedicines', 'getPharmacyAvailableMedicines', 'getPharmacyFeaturedMedicines'])) {
        ...
        child: CustomScrollView(
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              title: Text(
                controller.pharmacy.value.name,
                            ...
                            return Padding(
                              ...
                              child: RawChip(
                                ...
                                onSelected: (bool value) {
                                  ...
                                  controller.loadMedicinesOfCategory(filter: controller.selected.value);
                                },
                              ),
                            );
                          });
