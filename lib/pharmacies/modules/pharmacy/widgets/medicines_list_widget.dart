...
class MedicinesListWidget extends GetView<MedicinesController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (Get.find<PharmaciesLaravelApiClient>().isLoading(tasks: [
            ...
            'getPharmacyPopularMedicines',
            'getPharmacyMostRatedMedicines',
            'getPharmacyAvailableMedicines',
            'getPharmacyFeaturedMedicines',
          ]) &&
          controller.page == 1) {
