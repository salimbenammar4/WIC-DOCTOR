/*
 * File name: pharmacies_maps_carousel_loading_widget.dart
...
class PharmaciesMapsCarouselLoadingWidget extends StatelessWidget {
  const PharmaciesMapsCarouselLoadingWidget({
    Key? key,
  }) : super(key: key);
