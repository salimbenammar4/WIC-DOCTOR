              ...
              if (controller.loading.isTrue) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Obx(() {
                      bool isButtonDisabled = controller.smsSent.value.length != 6 || controller.isVerifying.value;
                      return BlockButtonWidget(
                        onPressed: isButtonDisabled
                            ? null
                            : () async {
                          controller.isVerifying.value = true; // Disable the button after pressing
