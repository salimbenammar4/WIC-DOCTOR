        ...
        return ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              return InkWell(
                ...
                child: Container(
                  width: 130,
                  margin: EdgeInsetsDirectional.only(end: 30, start: index == 0 ? 20 : 0),
                  ...
                  child: Stack(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.only(top: 30,start: 0,end: 0),
                        child: ClipRRect(
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.only(start: 3, bottom: 25),
                        child: Text(
                          _speciality.name.tr,
                          maxLines: 2,
