...
class ReviewPopupWidget extends StatefulWidget {
  final Clinic clinic;  // Add clinic as a parameter
  final VoidCallback onReviewAdded;
  // Modify the constructor to accept the clinic
  ReviewPopupWidget({required this.clinic, required this.onReviewAdded});
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    final review = Review(
                      ...
                      clinic: widget.clinic,  // Pass the clinic from the widget
                    );

                    final reviewcontroller = Get.find<ReviewsController>();  // Get the ReviewsController
                    reviewcontroller.addClinicReview(review);
