...
class CreatePatientViewFromBookDoctorView extends GetView<CreatePatientController> {
            ...
            children: [
              Expanded(
                child: MaterialButton(
                  onPressed: () {
                    controller.createPatientFormFromBookDoctor();
                  },
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              DatePickerWidget(
                ...
                hintText: "Choisir la date de naissance",
                initialValue: controller.patient.value.date_naissance.toString(),
                onDateSelected : (newDate) {
                  // Update the appointment's motif field in the controller
                  controller.patient.value.date_naissance = newDate;
                },
              ),
                TextFieldWidget(
